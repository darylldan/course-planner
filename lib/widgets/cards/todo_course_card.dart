...
class TodoCourseCard extends StatefulWidget {
  final Subject subject;
  const TodoCourseCard({super.key, required this.subject});

  @override
  State<TodoCourseCard> createState() => _TodoCourseCardState();
}

class _TodoCourseCardState extends State<TodoCourseCard> {
  @override
          ...
          child: InkWell(
            ...
            onTap: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          ViewCourseTodo(course: widget.subject)));
            },
  ...
  Widget _todoCount(BuildContext context) {
    int count = context
        .watch<TodoProvider>()
        .getAllUncompletedTodoByCourse(
            widget.subject.termID, widget.subject.id!)
        .length;
    return Container(
      decoration: BoxDecoration(
