...
void _userSettingsSerialize(
  ...
  writer.writeLong(offsets[0], object.currentTerm);
}
...
UserSettings _userSettingsDeserialize(
  ...
  object.currentTerm = reader.readLongOrNull(offsets[0]);
  object.id = id;
  return object;
}
  ...
  QueryBuilder<UserSettings, UserSettings, QAfterFilterCondition>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'currentTerm',
      ));
    });
  }

  QueryBuilder<UserSettings, UserSettings, QAfterFilterCondition>
      currentTermIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension UserSettingsQuerySortBy
  ...
  QueryBuilder<UserSettings, UserSettings, QAfterSortBy> sortByCurrentTerm() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentTerm', Sort.asc);
    });
  }

  QueryBuilder<UserSettings, UserSettings, QAfterSortBy>
      sortByCurrentTermDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentTerm', Sort.desc);
    });
  }
}
...
extension UserSettingsQuerySortThenBy
  ...
  QueryBuilder<UserSettings, UserSettings, QAfterSortBy> thenByCurrentTerm() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currentTerm', Sort.asc);
    });
  }
...
extension UserSettingsQueryWhereDistinct
  ...
  QueryBuilder<UserSettings, UserSettings, QDistinct> distinctByCurrentTerm() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'currentTerm');
    });
  }
}
...
extension UserSettingsQueryProperty
  ...
  QueryBuilder<UserSettings, int?, QQueryOperations> currentTermProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'currentTerm');
    });
  }
}
